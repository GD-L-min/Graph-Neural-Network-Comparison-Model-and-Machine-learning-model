...
METRICS_PATH = BASE_DIR / "lightgbm_performance_metrics.txt"
FIGURE_PATH = BASE_DIR / "LightGBM_Performance.png"
...
grid_search = GridSearchCV(lgbm, param_grid=param_grid, cv=10, n_jobs=8)
